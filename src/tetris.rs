...
impl<'a> Tetris<'a> {
    pub fn new(scale: f64, texture: &'a G2dTexture, initial_stack_size: usize) -> Tetris {
    ...
    pub fn render(&mut self, c: &piston_window::Context, g: &mut G2d) {
